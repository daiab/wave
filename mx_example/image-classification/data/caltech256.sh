...
MX_DIR=${CUR_DIR}/../../../
python ./tools/im2rec.py --list True --recursive True caltech256-train ${TRAIN_DIR}/
python ./tools/im2rec.py --list True --recursive True caltech256-val 256_ObjectCategories/
...
# generate rec files
python ./tools/im2rec.py --resize 256 --quality 95 --num-thread 16 caltech256-val 256_ObjectCategories/
python ./tools/im2rec.py --resize 256 --quality 95 --num-thread 16 caltech256-train ${TRAIN_DIR}/
